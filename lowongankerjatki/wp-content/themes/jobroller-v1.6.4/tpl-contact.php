...
<?php 
	...
	if (isset($_POST['submit-form'])) {		
		...
		$loc_keys = array( 
			...
			'email' => __( 'Email', 'appthemes' ),
			'message' => __( 'Message', 'appthemes' ),
			'spam-trap' => __( 'Spam-Trap', 'appthemes' ),
		);
		...
		foreach ($posted as $key => $val) {
			...
			if (in_array($key, $required)) {
				if (empty($val)) $errors->add('submit_error', __('Required field "','appthemes').$loc_keys[$key].__('" missing.','appthemes'));
			}
