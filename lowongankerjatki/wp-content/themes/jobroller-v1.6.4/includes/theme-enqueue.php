...
function jr_load_scripts() {
	...
	$params = array(
		...
		'si_empty'						=> __('Strength indicator','appthemes'),
		'si_short' 						=> __('Very weak','appthemes'),
		'si_bad' 						=> __('Weak','appthemes'),
		'si_good' 						=> __('Medium','appthemes'),
		'si_strong'						=> __('Strong','appthemes'),
		'si_mismatch'					=> __('Mismatch','appthemes'),
	);
