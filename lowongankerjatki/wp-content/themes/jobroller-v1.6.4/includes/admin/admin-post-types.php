...
function jr_post_type() {
    ...
    register_taxonomy( APP_TAX_RESUME_SPECIALITIES,
        ...
        array('hierarchical' => false,                    
                'labels' => array(
                        'name' => __( 'Resume Specialties', 'appthemes'),
                        'singular_name' => __( 'Resume Specialty', 'appthemes'),
                        'search_items' =>  __( 'Search Resume Specialties', 'appthemes'),
                        'all_items' => __( 'All Resume Specialties', 'appthemes'),
                        'parent_item' => __( 'Parent Resume Specialty', 'appthemes'),
                        'parent_item_colon' => __( 'Parent Resume Specialty:', 'appthemes'),
                        'edit_item' => __( 'Edit Resume Specialty', 'appthemes'),
                        'update_item' => __( 'Update Resume Specialty', 'appthemes'),
                        'add_new_item' => __( 'Add New Resume Specialty', 'appthemes'),
                        'new_item_name' => __( 'New Resume Specialty Name', 'appthemes')
                ),
                'show_ui' => $show_ui,
