		...
		<fieldset>
			...
			<p class="optional"><label for="availability_month"><?php _e('Your Availability <small>(Leave blank for immediate availability)</small>', 'appthemes'); ?></label> 
				<span class="date_field_wrap">
					...
					<input type="text" class="text" name="availability_year" maxlength="4" size="4" placeholder="<?php _e('YYYY','appthemes'); ?>" value="<?php if ( !empty($availability_year) ) echo $availability_year; ?>" id="availability_year" />
				</span>
			</p>
