...
(function($) {
    ...
    $.skitter = function(obj, options, number) {
		...
		function responsive(){
			var width = self.box_skitter.parent().width()-(parseInt(self.box_skitter.css('margin-left'))||0);
    ...
    $sk.fn.extend({
        ...
        setup: function() 
        {
            ...
            if (self.settings.thumbs && !self.settings.fullscreen) 
            {
                ...
                if(self.settings.navigation_directory == 'horizontal'){
                    ...
                    var width_info_slide=u*(parseInt(self.settings.thumb_width)+5);
        ...
        nextImage: function() 
        {
			...
			if(this.settings.thumbs && !navPipe.is(':hover')){
				if(this.settings.navigation_directory == 'horizontal'){
					if (navPipe.width() > navPipe.parent().width()){ 
							...
							var pipeWidth = navPipe.outerWidth(true);
							var viewWidth = navPipe.parent().outerWidth(true);
							...
							if(this.settings.image_i == navigation.length-1){
