...
class JFormFieldFetchImage extends JFormField {
    ...
    protected function _build($moduleID){
        ...
        $btnGetImages = JText::_("MOD_BTSLIDESHOW_BUTTON_GETIMAGES");
                ...
                <script type= "text/javascript">
                    ...
                    jQuery(document).ready(function(){
                        ...
                        jQuery("#btnGetImages").click(function(){
                            if(inProgess.value){
                                alert("'.JText::_('MOD_BTSLIDESHOW_ERROR_ON_PROGESS').'");
                            }else{
                                ...
                                switch (source){
                                    case "jfolder":
                                        if(jQuery("#jform_params_jfolder_path").val()!=""){
                                            ...
                                            alert("'.JText::_("MOD_BTSLIDESHOW_JOOMLAFOLDER_ALERT").'");
                                            return false;
                                        }
                                    ...
                                    case "flickr":
                                        if(jQuery("#jform_params_flickr_api").val() != "" && jQuery("#jform_params_flickr_userid").val() != ""){
                                            ...
                                            alert("'.JText::_("MOD_BTSLIDESHOW_FLICKR_ALERT").'");
                                            return false;
                                        }
                                        break;
                                    case "picasa":
                                        if(jQuery("#jform_params_picasa_userid").val() !=""){
                                            ...
                                            alert("'.JText::_('MOD_BTSLIDESHOW_PICASA_ALERT').'");
                                            return false;
                                        }
                                        break;
                                    case "phocagallery":
                                        if(phocaExists == 1){
                                            ...
                                            alert("'.JTEXT::_('MOD_BTSLIDESHOW_PHOCA_ALERT').'");
                                            return false;
                                        }
                                        break;
                                    case "jgallery":
                                        if(jgalleryExists == 1){
                                            ...
                                            alert("'.JTEXT::_('MOD_BTSLIDESHOW_JOOMGALLERY_ALERT').'");
                                            return false;
                                        }
                                        break;
                                    default:
                        ...
                        jQuery("#btnDeleteAll").click(function(){
                            if(jQuery("#btss-gallery-container li").length > 0){
                                if(confirm("'.JText::_('MOD_BTSLIDESHOW_CONFIRM_DELETE_ALL').'")){
                    ...
                    function sendRequest(files, i, BTSlideshow, strParams, inProgess){
                        if(i < files.length){
                            jQuery.ajax({
                                url: location.href,
                                data: "action=upload&id='.$moduleID.'&btfile="+ files[i].file + "&title="+files[i].title + "&source="+files[i].source+ strParams,
                                type: "post",
                                beforeSend: function(){
                                    var j;
                                    ...
                                    var filename = files[i].file.substr(j+1);
