    ...
    protected function _build($moduleID, $name, $value) {
        ...
        ?>
                    '<fieldset style="clear: both;" class="adminform">' +
                        ...
                        '<li>' +
                        '<label id="btss-title-lbl" class="hasTip" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_TITLE_DESC'); ?>" for="btss-title"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_TITLE_LABEL'); ?></label>' +
                        '<input id="btss-title" type="text" name="btss-title" size="90" />' +
                        '</li>' +
                        '<li>' +
                        '<label id="btss-link-lbl" class="hasTip" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_LINK_DESC'); ?>" for="btss-link"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_LINK_LABEL'); ?></label>' +
                        '<input id="btss-link" type="text" name="btss-link" size="90" />' +
                        '</li>' +
                        '<li>' +
                        '<label id="btss-target-lbl" class="hasTip" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_TARGET_DESC'); ?>" for="btss-target"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_TARGET_LABEL'); ?></label>' +
                        ...
                        '</li>' +						
                        '<li>' +
                        '<label id="btss-desc-lbl" class="hasTip" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_DESCRIPTION_DESC'); ?>" for="btss-desc"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_DESCRIPTION_LABEL'); ?></label>' +
                        '<textarea style="width: 375px;" id="btss-desc" name="btss-desc" rows="2" cols="20"></textarea>' +
                        '</li>' +
                        '</ul>' +                      
                        '</fieldset>' +						
						'<fieldset style="clear: both;" class="adminform" > '+
						'<legend><label  class="hasTip" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_URL_DESC'); ?>" ><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_URL_LABEL'); ?></label></legend>'+
							'<ul class="embledvideo">' +
								'<li>'+
									'<label id="btss-youid-lbl" class="hasTip"  for="btss-youid"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_ID_LABEL'); ?></label>'+								
									'<input id="btss-youid" type="text" name="btss-youid" size="40" />' +
								'</li>'+
							'</ul>'+
							'<ul>'+
								'<li>'+
								'<label id="btss-quality-lbl" class="hasTip"  for="btss-quality"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_QUANLITY_LABEL'); ?></label>'+								
								'<select id="btss-quality" name="btss-quality" style="width:150px;">' +
									...
									'<option value="large" selected><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_480P') ?></option>'+
									...
									'<option value="highres"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_LARGER_1080P') ?></option>'+
								'</select>'  +
								'</li>'+
							'</ul>'+
							'<ul>'+
								'<li>'+
									'<label id="btss-autoplay-lbl" class="hasTip"  for="btss-autoplay"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_AUTOPLAY_LABEL'); ?></label>'+								
									'<select id="btss-autoplay" name="btss-auto" style="width:150px;">' +
										'<option value="0"><?php echo JText::_('JNO') ?></option>'+
										'<option value="1" selected><?php echo JText::_('JYES') ?></option>'+
									'</select>'+
								'</li>'+
								'<li>' +
									'<label id="btss-volume-lbl" class="hasTip"  for="btss-volume"><?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_VOLUME_LABEL'); ?></label>' +
									'<input id="btss-volume" type="text" name="btss-volume" size="40" value="100" title="<?php echo JText::_('MOD_BTBGSLIDESHOW_FIELD_VOLUME_TITLE'); ?>" />' +										
								'</li>' +
							'</ul>'+		
