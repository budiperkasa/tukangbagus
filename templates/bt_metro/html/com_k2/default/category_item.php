...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody">
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore" title="<?php echo JText::_('K2_READ_MORE'); ?>" href="<?php echo $this->item->link; ?>">
  ...
  <div class="bg-title-item">      
      ...
      <div class="bg-infor-item">
		...
		<span class="catItemAuthor">
            ...
            <?php echo JText::_('K2_POST_BY_BT'); ?>
		...
		<div class="catItemCategory">
			<span><?php echo JText::_('K2_PUBLISHED_IN_BT'); ?></span>
...
<?php endif; ?>
  ...
  <div class="catItemLinks">
		...
		<div class="catItemHitsBlock">
			...
			<!--	<div class="catItemHits-inner"> --> <b><?php echo JText::_('K2_READ'); ?></b> <?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?> <!--</div>-->
			</span>
		</div>
     <!--   <script type="text/javascript">
			jQuery(".catItemTagsBlock").css("margin-left", 128 + 'px');
		</script> -->
		<?php endif; ?>
    ...
    <!--  <div class="catItemTagsBlock-inner"> -->
