	  ...
	  <div class="bg-item-header-img">
	    <div class="itemImageBlock">
	      ...
	      <span class="itemDateCreated">
            ...
            <?php echo '<span class="date-day">'.JHTML::_('date', $this->item->created , JText::_('d')).'</span><br /><span class="date-month">'.JHTML::_('date', $this->item->created , JText::_('F')).'</span>'; ?>
          </span>
	      <?php endif; ?>
          ...
          <?php if($this->item->params->get('itemCommentsAnchor') && $this->item->params->get('itemComments') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
			...
			<div class="itemCommentsLink-head">
...
<?php if(!empty($this->item->fulltext)): ?>
  ...
  <?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemHits') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments')): ?>
  <div class="itemLinks">
  		...
  		<?php if($this->item->params->get('itemHits')): ?>
			<!-- Item Hits -->
			<span class="itemHits">
				<div class="itemHits-inner"><?php echo JText::_('K2_READ'); ?> <br /> <b><?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?></b></div>
			</span>
			<?php endif; ?>
		...
		<div class="itemCategory">
			<div class="itemCategory-inner"><span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span><br />
			<b><a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a></b></div>
		</div>
		<?php endif; ?>
	  ...
	  <div class="itemTagsBlock">
		  <div class="itemTagsBlock-inner"><span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span><br />
		  <ul class="itemTags">
