...
function pagination_list_render($list)
{
	...
	*/
	...
	$html = '<ul class="my-pagination">';
		$html .= '<li class="pagination-start chung">' . $list['start']['data'] . '</li>';
		$html .= '<li class="pagination-prev chung">' . $list['previous']['data'] . '</li>';
		foreach ($list['pages'] as $page)
		{
			$html .= '<li class="page-number">' . $page['data'] . '</li>';
		}
		$html .= '<li class="pagination-next chung">' . $list['next']['data'] . '</li>';
		$html .= '<li class="pagination-end chung">' . $list['end']['data'] . '</li>';
		$html .= '</ul>';
	return $html;
}
